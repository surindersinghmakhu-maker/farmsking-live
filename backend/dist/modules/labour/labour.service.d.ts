...
export declare class LabourService {
    ...
    createWorker(farmerId: string, dto: CreateLabourWorkerDto): Promise<{
        user: {
            id: string;
            mobile: string;
        } | null;
    ...
    getWorkersForFarmer(farmerId: string): Promise<{
        totalEarned: number;
        totalPaid: number;
    ...
    updateWorker(farmerId: string, id: string, dto: UpdateLabourWorkerDto): Promise<{
        id: string;
        mobile: string | null;
        name: string;
        createdAt: Date;
    ...
    deleteWorker(farmerId: string, id: string): Promise<{
        id: string;
        mobile: string | null;
        name: string;
        createdAt: Date;
