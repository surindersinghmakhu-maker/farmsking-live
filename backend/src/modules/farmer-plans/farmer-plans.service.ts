    ...
    if (dto.billingPeriodDays != null && Number(dto.billingPeriodDays) > 0) {
      ...
      return this.prisma.farmerPlanPricing.upsert({
        ...
        create: {
          ...
          offerValidTill: dto.offerValidTill ? new Date(dto.offerValidTill) : undefined,
        ...
        update: {
          ...
          ...(dto.isOffer !== undefined ? { isOffer: dto.isOffer } : {}),
          ...(dto.offerName !== undefined ? { offerName: dto.offerName } : {}),
          ...(dto.offerPrice !== undefined ? { offerPrice: dto.offerPrice } : {}),
          ...(dto.offerValidTill !== undefined ? { offerValidTill: dto.offerValidTill ? new Date(dto.offerValidTill) : null } : {}),
