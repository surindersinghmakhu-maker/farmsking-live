...
export const COMBINED_EXPENSE_CATEGORIES = [
  ...
  },
  {
    ...
    labelPa: 'ਖਾਦ / ਦੇਸੀ ਰੂੜੀ',
    labelHi: 'खाद व उर्वरक',
    icon: 'flask-outline',
  },
  {
    id: 'cat_crop_care',
    ...
    labelPa: 'ਫਸਲ ਦੀ ਦੇਖਭਾਲ',
    labelHi: 'फसल की देखभाल',
    icon: 'medkit-outline',
  },
  {
    id: 'cat_irrig_power',
    ...
    labelPa: 'ਸਿੰਚਾਈ / ਡੀਜ਼ਲ',
    labelHi: 'सिंचाई व बिजली',
    icon: 'water-outline',
  },
  {
    id: 'cat_spray_pest',
    ...
    labelPa: 'ਕੀਟਨਾਸ਼ਕ ਸਪ੍ਰੇ',
    labelHi: 'कीटनाशक स्प्रे',
    icon: 'shield-checkmark-outline',
  },
  {
    id: 'cat_labour',
    key: 'labour',
    labelEn: 'Labour & Dihadi',
    labelPa: 'ਮਜ਼ਦੂਰੀ / ਦਿਹਾੜੀ',
    labelHi: 'मजदूरी व दिहाड़ी',
    icon: 'people-outline',
  },
  {
    id: 'cat_machinery',
    ...
    labelPa: 'ਟਰੈਕਟਰ / ਮਸ਼ੀਨਰੀ',
    labelHi: 'ट्रैक्टर व मशीनरी',
  ...
  },
  {
    ...
    labelPa: 'ਟ੍ਰਾਂਸਪੋਰਟ / ਭਾੜਾ',
    labelHi: 'परिवहन व भाड़ा',
    icon: 'bus-outline',
  },
  {
    id: 'cat_mandi_pack',
...
const LABOUR_WORK_TYPES = [
  { id: 'harvesting', label: '🌾 Harvesting / ਕਟਾਈ' },
  { id: 'sowing', label: '🌱 Sowing / ਬਿਜਾਈ' },
  { id: 'weeding', label: '🌿 Weeding / ਗੋਡੀ' },
  { id: 'spraying', label: '🧴 Spraying / ਸਪਰੇਅ' },
  { id: 'loading', label: '📦 Loading / ਪੈਕਿੰਗ' },
  { id: 'irrigation', label: '💧 Irrigation / ਪਾਣੀ' },
  { id: 'general', label: '🚜 General / ਦਿਹਾੜੀ' },
];
                      ...
                      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                        ...
                        {saleItems.length > 0 && (
                          <View style={{ backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#e2e8f0', borderRadius: RADIUS.md, padding: 10, marginBottom: 10 }}>
                            ...
                            {/* Received Amount Input for Credit/Party only */}
                            {paymentMode === 'PARTY' ? (
                              <View style={{ marginBottom: 8 }}>
                                <Text style={{ fontSize: 10.5, fontFamily: FONT.bold, color: '#334155', marginBottom: 3 }}>Amount Received Now (₹)</Text>
                                <TextInput
                                  style={{ borderWidth: 1, borderColor: '#cbd5e1', borderRadius: RADIUS.md, paddingHorizontal: 8, paddingVertical: 4, fontSize: 12.5, fontFamily: FONT.bold, color: '#0f172a', backgroundColor: '#fff', height: 36 }}
                                  placeholder="0"
                                  placeholderTextColor="#94a3b8"
                                  keyboardType="numeric"
